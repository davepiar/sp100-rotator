...
class FMPClient:
    ...
    def get_historical_prices(self, symbol: str, days: int = 365) -> Optional[dict]:
        ...
        # Try FMP stable /historical-price-eod/full (returns a list newest-first)
        ...
        while True:
            ...
            try:
                ...
                if r.status_code != 200:
                    return None
                j = r.json()
                b = j.get("bars", {}).get(symbol_for_fetch, [])
                bars.extend(b)
